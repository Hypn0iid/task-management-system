...
SECRET_KEY = 'django-insecure-q9fwj#j+#oh74wn0_7(#uqn_+$42c&8^c6(lwj*g_6^(bwbwk1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'taskmanagementsystem', #change accordingly
        'USER': 'postgres', #change accordingly
        'PASSWORD': 'igor', #change accordingly
        'HOST': '192.168.1.252', #change accordingly
